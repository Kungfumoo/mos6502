...
namespace MOS_6502
{
    ...
    protected:
        ...
        virtual unsigned short getAbsolute(); //will get an absolute address based on the next two bytes from the program counter.
        virtual unsigned short getPreIndirect(); //will get a pre-indexed indirect address from the next byte from the program counter.
        virtual unsigned short getPostIndirect(); //will get a post-indexed indirext address from the next byte from the pc
        virtual unsigned short getZeroPageIndexed(byte regValue); //will get a zero-page indexed address from the next byte from the program counter.
